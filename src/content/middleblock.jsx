...
const Middleblock = () => {
    return (
        <div className='w-full flex flex-col gap-[10px]'>
            ...
            <Card className="rounded-[20px] bg-[#4749B3] hover:bg-white md:px-16 max-md:gap-10 md:py-10 flex md:flex-col items-center group transition-colors duration-300">
                ...
                <h4 className="text-center text-[24px] 2xl:text-[32px] font-bold md:mt-3 md:mb-1 text-white group-hover:text-[#4749B3] transition-colors duration-300">
                    Canvas LMS
                </h4>
            ...
            <Card className="rounded-[20px] bg-[#E66DFF] hover:bg-white md:px-16 max-md:gap-10 md:py-10 flex md:flex-col items-center group transition-colors duration-300">
                <div className="md:flex hidden group-hover:hidden">
                ...
                <h4 className="text-center text-[24px] 2xl:text-[32px] font-bold md:mt-3 md:mb-1 text-white group-hover:text-[#E66DFF] transition-colors duration-300">
                    Join Live Class
                </h4>
            ...
            <Card className="rounded-[20px] bg-[#6669FE] hover:bg-white md:px-16 max-md:gap-10 md:py-10 flex md:flex-col items-center group transition-colors duration-300">
                <div className="md:flex hidden group-hover:hidden">
                ...
                <h4 className="text-center text-[24px] 2xl:text-[32px] font-bold md:mt-3 md:mb-1 text-white group-hover:text-[#6669FE]  transition-colors duration-300">
                    Contact Teacher
                </h4>
